...
- `POST /evaluate`: _Endpoint_ utama untuk memulai proses evaluasi. Payload akan berisi referensi ID dari _file-file_ yang telah diunggah dan _job description_.
